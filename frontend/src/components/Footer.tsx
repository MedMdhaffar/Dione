...
const Footer: React.FC = () => {
  ...
  return (
    <footer className={`relative backdrop-blur-sm border-t py-12 px-6 transition-all duration-300 ${
      isDark 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className={`mb-6 max-w-md transition-colors duration-300 ${
              ...
              Revolutionizing social media automation with AI-powered trend detection and content creation. 
              Built by the innovative TakTik team under DIONE.
            </p>
            <div className="flex space-x-4">
              <a href="#" className={`w-10 h-10 rounded-full flex items-center justify-center hover:scale-110 transition-transform ${
                isDark 
