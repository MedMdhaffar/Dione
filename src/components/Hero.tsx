  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6">
      <div className="container mx-auto text-center">
        <div className="mb-8">
          <div className={`inline-flex items-center px-4 py-2 rounded-full border mb-6 transition-all duration-300 ${
            isDark 
              ? 'bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border-cyan-500/20' 
              : 'bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-purple-500/20'
          }`}>
            <Zap className={`w-4 h-4 mr-2 transition-colors duration-300 ${
              isDark ? 'text-cyan-400' : 'text-purple-600'
            }`} />
            <span className={`text-sm transition-colors duration-300 ${
              isDark ? 'text-gray-300' : 'text-gray-700'
            }`}>Powered by DIONE Team</span>
          </div>
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            ...
            <br />
            <span className={`text-3xl md:text-5xl transition-colors duration-300 ${
          ...
          <p className={`text-xl mb-8 max-w-3xl mx-auto leading-relaxed transition-colors duration-300 ${
            ...
            Detect trending topics, create viral content, and automate your social media presence across 
            TikTok, Instagram, Facebook, and Twitter with cutting-edge AI technology.
          </p>
        </div>
        
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <button className={`group px-8 py-4 rounded-full text-white font-semibold text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex items-center ${
            isDark 
          ...
          <button className={`px-8 py-4 border rounded-full font-semibold text-lg transition-all duration-300 flex items-center ${
            isDark 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className={`backdrop-blur-sm border rounded-2xl p-6 transition-all duration-300 group ${
            ...
            }`}>Advanced web scraping to identify viral topics in real-time</p>
          </div>
          ...
          <div className={`backdrop-blur-sm border rounded-2xl p-6 transition-all duration-300 group ${
            ...
            <Play className={`w-8 h-8 mb-4 group-hover:scale-110 transition-transform ${
            ...
            <p className={`transition-colors duration-300 ${
              isDark ? 'text-gray-400' : 'text-gray-600'
            }`}>Automatically find, edit, and upload viral clips to TikTok & Reels</p>
          </div>
          ...
          <div className={`backdrop-blur-sm border rounded-2xl p-6 transition-all duration-300 group ${
            ...
            <Bot className={`w-8 h-8 mb-4 group-hover:scale-110 transition-transform ${
            ...
            <p className={`transition-colors duration-300 ${
              isDark ? 'text-gray-400' : 'text-gray-600'
            }`}>Generate images and posts for all social media platforms</p>
          </div>
        </div>
      </div>
    </section>
